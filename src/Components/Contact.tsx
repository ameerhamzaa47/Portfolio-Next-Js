...
const Contact = () => {
    return (
        <section id='contact-section' className='grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative'>
            ...
            <div>
                <form method='POST' action="https://formspree.io/f/xyzezlrk" className='flex flex-col'>
                    <div className='mb-6'>
                        <label htmlFor="name" className='text-white block mb-2 text-sm font-medium'>Name</label>
                        <input type="text" id="name" name='Name' className='bg-[#18191E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5' required placeholder='example@gmail.com' />
                    </div>
                    <div className='mb-6'>
                        <label htmlFor="email" className='text-white block mb-2 text-sm font-medium'>Email</label>
                        <input type="email" id="email" name='Email' className='bg-[#18191E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5' required placeholder='Just Saying Hi' />
                    </div>
                    <div className='mb-6'>
                        <label htmlFor="message" className='text-white block mb-2 text-sm font-medium'>Message</label>
                        <textarea id="message" name='Message' className='bg-[#18191E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5' required placeholder="Let's talk about..." />
                    </div>
